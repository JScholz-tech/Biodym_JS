...
def create_excel_template(output_path="data/01_input/BioDYM_MFA_Input_Template.xlsx"):
    ...
    section_fill = PatternFill(
        start_color="D0D8E4", end_color="D0D8E4", fill_type="solid"
    )
    ...
    export_validation = DataValidation(
        type="list", formula1='"Excel,CSV,JSON"', allow_blank=True
    )
    ws_config.add_data_validation(export_validation)
    export_validation.add("B21")  # Export Format

    # Plot style options
    plot_validation = DataValidation(
        type="list", formula1='"Line,Bar,Scatter"', allow_blank=True
    )
    ...
    color_validation = DataValidation(
        type="list", formula1='"Default,Colorblind,High Contrast"', allow_blank=True
    )
    ws_config.add_data_validation(color_validation)
    color_validation.add("B25")  # Color Scheme

    # Dashboard layout options
    layout_validation = DataValidation(
        type="list", formula1='"Grid,Flow,Compact"', allow_blank=True
    )
    ws_config.add_data_validation(layout_validation)
    layout_validation.add("B27")  # Dashboard Layout

    # Data validation level options
    validation_level = DataValidation(
        type="list", formula1='"Strict,Moderate,Relaxed"', allow_blank=True
    )
    ...
    compare_validation = DataValidation(
        type="list", formula1='"Yes,No"', allow_blank=True
    )
    ...
    process_data = [
        ...
        [
            ...
            "No",
            "Processing",
            "Straw decomposition and consumption",
        ],
        [
            "P_6",
    ...
    process_type_validation = DataValidation(
        type="list",
        formula1='"Environment,Production,Processing,Utilization,Treatment,DSM,FOMP"',
        allow_blank=True,
    )
    ...
    flow_data = [
        [
            "F_00_02",
            "Atmosphere to Cultivation",
            "P_0",
            "P_2",
            "Input",
            "Atmospheric input to cultivation",
        ],
        [
            "F_01_02",
            "Environment to Cultivation",
            "P_1",
            "P_2",
            "Input",
            "Environmental input to cultivation",
        ],
        [
            "F_02_03",
        ...
        [
            "F_04_00",
            "Grain Processing to Atmosphere",
            "P_4",
            "P_0",
            "Emission",
            "CO2 emission",
        ...
        [
            "F_04_01",
            "Grain Processing to Environment",
            "P_4",
            "P_1",
            "Emission",
            "Waste emission",
    ...
    flow_type_validation = DataValidation(
        type="list",
        formula1='"Input,Output,Product,Waste,Emission,Transfer"',
        allow_blank=True,
    )
    ...
    # TC headers
    tc_headers = ["Process_ID", "Flow_ID_O", "Flow_ID_I", "TC_Value", "Description"]
    ...
    # Dynamic TC headers
    dynamic_tc_headers = ["TC_ID", "Year", "Value", "Description"]
    ...
    # DSM headers
    dsm_headers = ["Process_ID", "DSM_Type", "Decay_Rate", "Description"]
    ...
    dsm_type_validation = DataValidation(
        type="list", formula1='"Exponential,Linear,Weibull"', allow_blank=True
    )
    ...
    # FOMP headers
    fomp_headers = ["Process_ID", "Outflow_ID", "f", "k1", "k2", "Description"]
    ...
    uncertainty_data = [
        ...
        [
            "F_02_03",
            "Cultivation to Harvest Flow",
            "Normal",
            200,
            20,
            160,
            240,
            "Uncertainty in harvest flow",
        ],
        [
            "k1",
            "FOMP k1 parameter",
    ...
    dist_validation = DataValidation(
        type="list", formula1='"Normal,Uniform,LogNormal,Triangular"', allow_blank=True
    )
...
if __name__ == "__main__":
    ...
    print("   2. Configure your model in the 'Configuration' sheet")
    print("   3. Define your processes and flows")
    print("   4. Add your time series data")
    print("   5. Run your MFA analysis!")
