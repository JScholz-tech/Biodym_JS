...
NODE_LABEL_MAX_CHARS = 20  # Maximum characters per line before wrapping (0 = no wrapping)
...
GRID_VERTICAL_POSITIONS = [0.25, 0.5, 0.75] # Positions as fraction of width (e.g., 0.25 = 25% from left)
